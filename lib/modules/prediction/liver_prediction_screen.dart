                      ...
                      onPressed: () {
                        if (formKey.currentState!.validate()) {
                          if (context.read<MainCubit>().hasInternet) {
                            cubit.makeLiverPrediction(
                                age: ageController.toString(),
                                gender: cubit.selectedGender,
                                totalPilirubin: totalBilirubinController.text,
                                directBilirubin: directBilirubinController.text,
                                alkalinePhosphotase:
                                ...
                                totalProtiens: totalProtiensController.text,
