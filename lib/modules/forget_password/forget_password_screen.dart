...
class ForgetPasswordScreen extends StatelessWidget {
    ...
    return BlocConsumer<PhoneAuthCubit, PhoneAuthStates>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(),
          body: Responsive(
            mobile: buildMobileForgetPasswordScreen(context, size, cubit),
            desktop: buildDesktopForgetPasswordScreen(context, size, cubit),
            tablet: buildDesktopForgetPasswordScreen(context, size, cubit),
          ),
        );
      },
    );
  ...
  Padding buildDesktopForgetPasswordScreen(
  ...
  Padding buildMobileForgetPasswordScreen(
      BuildContext context, Size size, PhoneAuthCubit cubit) {
    return Padding(
