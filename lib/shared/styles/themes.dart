...
ThemeData lightTheme = ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    enabledBorder:
        OutlineInputBorder(borderSide: BorderSide(color: myFavColor)),
  ...
  buttonTheme: ButtonThemeData(
      shape: OutlineInputBorder(borderSide: BorderSide(color: myFavColor1))),
  ...
  textTheme: TextTheme(
    ...
    bodyText2: TextStyle(
        fontFamily: "Almarai-Regular", color: myFavColor3, fontSize: 18),
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    selectedLabelStyle:
        const TextStyle(fontFamily: "Almarai-Bold", fontSize: 12),
    unselectedLabelStyle:
        const TextStyle(fontFamily: "Almarai-Regular", fontSize: 12),
  ),
);
...
ThemeData darkTheme = ThemeData(
  ...
  buttonTheme: ButtonThemeData(
      shape: OutlineInputBorder(borderSide: BorderSide(color: myFavColor5))),
  inputDecorationTheme: InputDecorationTheme(
    enabledBorder:
        OutlineInputBorder(borderSide: BorderSide(color: myFavColor5)),
    border: OutlineInputBorder(borderSide: BorderSide(color: myFavColor5)),
  ),
  iconTheme: IconThemeData(
    color: myFavColor5,
  ),
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    type: BottomNavigationBarType.fixed,
    selectedLabelStyle:
        TextStyle(color: myFavColor5, fontFamily: "Almarai-Bold", fontSize: 12),
