...
Color lightRose = HexColor("#fbedee"); //lightRose
Color calendarBg = HexColor("#bababa"); //dark grey
...
Color myFavColor3 = HexColor("#000000"); //black

// dark mood
Color myFavColor4 = HexColor("#555861"); //grey dark
Color myFavColor5 = HexColor("#9da1aa"); //grey light dark
Color myFavColor6 = HexColor("#f2f7fb"); //semi white
...
Color myFavColor10 = HexColor("#ececec"); // white with grey
Color myFavColor11 = HexColor("#30FF1E"); //green
